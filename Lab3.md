...
- Based on what I said earlier and according to that same website, the `-E` option just "automatically exits upon reaching the end of file." I believe the importence of this option is to save the hassle and time for a coder to just quickly end the file when he or she reaches to the end without typing `q`.
